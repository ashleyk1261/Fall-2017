...
public class BlackJackController implements Initializable {
	...
	public void btnHit_Click(ActionEvent event) {
		...
		rotT.setFromAngle(0);
		rotT.setToAngle(360);
		rotT.setInterpolator(Interpolator.LINEAR);
		rotT.setCycleCount(2000);
		rotT.setDuration(new Duration(1));
	...
	private PathTransition CreatePathTransition(Point2D fromPoint, Point2D toPoint, ImageView img) {
		...
		path.getElements().add(new ArcTo(30, 30, 400, toPoint.getX(), toPoint.getY()+40, false, false));
		path.getElements().add(new ArcTo(30, 30, 400, fromPoint.getX(), fromPoint.getY()+40, false, false));
		path.getElements().add(new ArcTo(30, 30, 400, toPoint.getX(), toPoint.getY()+40, false, false));
		System.out.println("From: " + fromPoint.getX() + ", " + fromPoint.getY());
		System.out.println("To: " + toPoint.getX() + ", " + toPoint.getY());
	...
	private ParallelTransition createFadeTransition(final ImageView imgVFadeOut, final Image imgFadeIn) {
		...
		FadeTransition fadeOutTransition = new FadeTransition(Duration.millis(0), imgVFadeOut);
		...
		FadeTransition fadeInTransition = new FadeTransition(Duration.millis(1), imgVFadeOut);
